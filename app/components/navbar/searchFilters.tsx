const SearchFilters = () => {
    return (
        <div className = "h-[64px] flex flex-row justify-between border rounded-full" >
            <div>
            ...
            <div className="p-2">
                <div className="cursor-pointer p-4 bg-airbnb hover:bg-aribnb-dark transition rounded-full text-white">
                    <svg 
                            viewBox="0 0 32 32" 
